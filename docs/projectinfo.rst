...
There is continuous integration for Python versions and 3.12+
...
``hyperlight-zstandard`` is a fork of ``python-zstandard`` with support for
Python 3.14 subinterpreters.
